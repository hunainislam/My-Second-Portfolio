...
export default function MobileCard() {
  return (
    <div className="h-[90vh] flex flex-col items-center justify-center bg-[#006666]">
        <div data-aos = "zoom-in" className="card bg-[#6b6b6b] w-80 p-5 flex flex-col justify-center items-center">
             {/* Image */}
      <Image
        src={Image1}
        alt="profile-pic"
  ...
  <h1 className="text-2xl text-center font-bold tracking-tight font uppercase">
      ...
      {/* Download CV Button */}
      <Link href= "/assests/CV/myCV.pdf" className="mt-4 w-full" target="_blank">
      <Button>
