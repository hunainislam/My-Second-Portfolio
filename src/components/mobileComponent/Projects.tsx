...
export default function MobileProjects() {
  ...
  return (
    <div id="projects" className="w-full p-5 bg-[#eeeeee]">
          ...
          <div key={i} className="lg:w-1/3 sm:w-1/2 p-4">
            <div className="flex relative">
              ...
              <div className="px-8 py-10 relative z-10 w-full border-4 border-gray-200 bg-white opacity-0 hover:opacity-100 cursor-pointer duration-300">
                ...
                <p className="mt-3 leading-relaxed text-[#006666] line-clamp-2">
                  {item.detail}
                </p>
                <Link
                  href={item.link}
                  target="_blank"
                  className="text-sm font-semibold tracking-tight hover:text-blue-500 hover:underline text-black"
                >
